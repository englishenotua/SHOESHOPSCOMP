      ...
      <div className="container">
        <div className="row order-detail">
          <div className="col-lg-4 col-sm-4 mb-lg-4 mb-5 mb-sm-0">
            <div className="row">
              ...
              <div className="col-md-8 center">
                ...
                <p>Admin Doe</p>
                <p>
                  <a href={`mailto:jobananada@gmail.com`}>jobananada@gmail.com</a>
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="col-lg-4 col-sm-4 mb-lg-4 mb-5 mb-sm-0">
            <div className="row">
              <div className="col-md-4 center">
                <div className="alert-succes order-box">
              ...
              <div className="col-md-8 center">
                ...
                <div className="bg-info p-2 col-12">
                  <p className="text-white text-center text-sm-start">Paid on Jan 12 2021</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="col-lg-4 col-sm-4 mb-lg-4 mb-5 mb-sm-0">
            <div className="row">
              ...
              <div className="col-md-8 center">
                ...
                <p>Address: Arusha Tz, Ngaramtoni Crater, P.O BOX 1234 Arush Tz</p>
